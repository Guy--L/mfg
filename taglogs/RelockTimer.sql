...
/****** Object:  Job [Lock HMIs after 5 minutes]    Script Date: 7/29/2015 7:58:03 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 7/29/2015 7:58:03 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Lock expired HMI records]    Script Date: 7/29/2015 7:58:04 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Lock expired HMI records', 
  ...
  where getdate() > Expires and RequestPending = 2', 
