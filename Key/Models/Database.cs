...
{
	public partial class keyDB : Database
	{
		public keyDB() 
			: base("key")
		{
		...
		public keyDB(string connectionStringName) 
		...
		[ThreadStatic] static keyDB _instance;
		...
		{
			public static keyDB repo { get { return keyDB.GetInstance(); } }
	...
	[ExplicitColumns]
    public partial class Channel : keyDB.Record<Channel>  
    {		
	...
	[PrimaryKey("HMIId")]
	[ExplicitColumns]
    public partial class HMI : keyDB.Record<HMI>  
    {		
	...
	[PrimaryKey("UserId")]
	[ExplicitColumns]
    public partial class User : keyDB.Record<User>  
    {		
